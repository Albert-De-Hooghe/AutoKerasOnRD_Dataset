...
if __name__ == "__main__":
    ...
    size = "mini"
    path_to_model = 'old_logs/image_classifier/best_model/'
    dataset_train, dataset_valid = RD_Dataset_train_5_classes(taille=size), RD_Dataset_valid_5_classes(taille=size)



    #model = GeneralNetwork(num_classes=5)  # ENAS

    #apply_fixed_architecture(model, args.arc_checkpoint)  # ENAS

    model = keras.models.load_model(path_to_model, custom_objects=ak.CUSTOM_OBJECTS)
